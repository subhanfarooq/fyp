...
<link rel="stylesheet" type="text/css" href="css/submitbuttonupdate.css">
 ...
 <br><br>
  ...
  <a class="back" href="adminsection.php"><font color=" white">Back</font></a>
        ...
        <center> <h2><b><font color="grey"> Edit HOD Account</font> </h2></center>		
                    ...
                    <center>
	<form action="edithodaccount.php" method="post" style="margin: 1; text-align: center;>				
...
$db->exec($query);	 
echo "<script>window.open('adminsection.php?changedhod=A HOD Account has been successfuly Changed.......!','_self')</script>";
